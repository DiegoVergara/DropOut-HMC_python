...
for _ in range(inference.n_iter):
    ...
    info_dict = inference.update(feed_dict={x: X_batch, y_ph: Y_batch,keep_prob:d_rate})
...
for _ in range(p_samples):
    ...
    X_drop=tf.nn.dropout(X_test,keep_prob=d_rate)
...
np.savetxt(path+"SGHMC_D_mnist_analysis.csv", result, fmt="%1.3f", header ="mean_0, mean_1, mean_2, mean_3, mean_4, mean_5, mean_6, mean_7, mean_8, mean_9, max_prob, pred, GT, var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9",delimiter = ",")
