...
data = pd.read_csv("SGHMC_D_mnist_analysis.csv", header = 0)

data[' GT'] = data[' GT'].astype(int)
columns_dict = {'# mean_0':'0', ' mean_1':'1', ' mean_2':'2', ' mean_3':'3', ' mean_4':'4', ' mean_5':'5', ' mean_6':'6', ' mean_7':'7', ' mean_8':'8', ' mean_9':'9', ' GT': ' GT', ' var_0':'v0', ' var_1':'v1', ' var_2':'v2', ' var_3':'v3', ' var_4':'v4', ' var_5':'v5', ' var_6':'v6', ' var_7':'v7', ' var_8':'v8', ' var_9':'v9'}
...
columns_var = ['v0', 'v1', 'v2', 'v3', 'v4', 'v5', 'v6', 'v7', 'v8', 'v9']


temp_mean = data[columns]
temp_var = data[columns_var]
temp_mean.plot(kind = "bar", yerr=temp_var, fontsize = 10)
plt.title("Histogram: Probability in the MNIST data set for class "+str(data[' GT']), fontsize=10)
plt.xlabel("Class", fontsize=10)
plt.ylabel("Mean of Probability", fontsize=10)
#plt.savefig("MNIST_mean_"+str(row)+"_histogram.png")
#plt.show()
pp = PdfPages('MNIST_mean_"+str(row)+"_histogram.pdf')
