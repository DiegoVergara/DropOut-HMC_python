...
np.savetxt(path+"SGHMC_D_mnist_analysis.csv", result, fmt="%1.3f", header ="mean_0, mean_1, mean_2, mean_3, mean_4, mean_5, mean_6, mean_7, mean_8, mean_9, max_prob, pred, GT, std_0, std_1, std_2, std_3, std_4, std_5, std_6, std_7, var_8, var_9",delimiter = ",")
