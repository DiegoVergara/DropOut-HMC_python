...
np.savetxt(path+"SGHMC_mnist_analysis.csv", result, fmt="%1.3f", header ="mean_0, mean_1, mean_2, mean_3, mean_4, mean_5, mean_6, mean_7, mean_8, mean_9, max_prob, pred, GT, var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9",delimiter = ",")
...
plt.savefig(path+"SGHMC_MNIST_t_data_acc_freq.png")
#plt.show()
plt.close()
...
plt.savefig(path+"SGHMC_MNIST_first_5_w.png")
#plt.show()
plt.close()
...
plt.savefig(path+"SGHMC_MNIST_gt.png")
#plt.show()
plt.close()
...
plt.ylabel("Frequency")
plt.savefig(path+"SGHMC_MNIST_digit_acc_freq.png")
#plt.show()
plt.close()
